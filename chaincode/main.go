...
// query callback mode 
// ************************************
func (t *DeviceUsageChaincode) Query(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
...
func (t *DeviceUsageChaincode) Init(stub shim.ChaincodeStubInterface,  function string, args []string) ([]byte, error) {
...
/************************ createUsage ********************/
func (t *DeviceUsageChaincode) updateDeviceAsAvailable(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
...
func (t *DeviceUsageChaincode) createUsage(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
    var usage Usage
    var device Device
	var err error
...
func (t *DeviceUsageChaincode) readDevice(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
    var device Device
    if len(args) != 1 {
...
func (t *DeviceUsageChaincode) readUsage(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
    var usage Usage
    if len(args) != 1 {
...
func (t *DeviceUsageChaincode) readUsageHistory(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
    var usage Usage
    if len(args) != 1 {
        return nil, errors.New("init expects one argument, a JSON string with device id")
    }
...
func (t *DeviceUsageChaincode) readDeviceList(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
    var devices DevList
    var devSlice []string
    var devList DevList
    devListKey:=LISTKEY
...
func (t *DeviceUsageChaincode) extendUsage(stub shim.ChaincodeStubInterface, args []string) ([]byte, error) {
    var usage Usage
    var usageStub Usage
    var device Device
	var err error
